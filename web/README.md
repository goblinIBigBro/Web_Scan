...
- **Remote SSH Environment Setup** (Recommended for remote training)
  ...
  - New Algorithms (HAC-plus, FCGS, ContextGS): [`project_md/REMOTE_SETUP_GUIDE_NEW.md`](project_md/REMOTE_SETUP_GUIDE_NEW.md)
  - Legacy Algorithms (CompGS, MEGS-2, etc.): [`project_md/REMOTE_SETUP_GUIDE_OLD.md`](project_md/REMOTE_SETUP_GUIDE_OLD.md)
